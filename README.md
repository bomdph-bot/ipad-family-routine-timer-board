...
本地打开 HTML 原型（无需任何服务器或依赖）：

```bash
open prototype/index.html
# 或直接在浏览器中打开 prototype/index.html
```

原型功能：
- 右上角按钮切换「开始前 / 进行中 / 超时」三种状态
- 点击顶部孩子头像切换 4 个孩子
- 点击当前任务卡片的 ✓ 按钮标记完成并推进下一任务
- 纯静态单文件，无外部依赖，可在 iPad Safari 中直接打开

## 当前状态

- 项目状态：`planned`
- 当前阶段：Phase 1 原型开发中（孩子主界面原型）
- 对应立项 Issue：#1
